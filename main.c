...
#define CLEAR_COLOR 0x800080FF // Purple background color in RGBA format
...
int main()
{
    ...
    // Print messages to the bottom screen
    printf("made by TylerGuyManCheese at https://github.com/TylerGuyManCheese\n");
